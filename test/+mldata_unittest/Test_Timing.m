classdef Test_Timing < matlab.unittest.TestCase
	...
	%  Usage:  >> results = run(mldata_unittest.Test_Timing)
 	%          >> result  = run(mldata_unittest.Test_Timing, 'test_dt')
	...
	methods (Test)
        ...
        function test_datetimes(this)
            ...
            d = this.testObj.datetimes;
            this.verifyEqual(d(1),   this.datetimeMeas);
            this.verifyEqual(d(end), this.datetimeMeas + seconds(99));
                
            this.testObj.time0 = 133;
            d = this.testObj.datetimes;
            this.verifyEqual(d(1),   this.datetimeMeas + seconds(33));
            this.verifyEqual(d(end), this.datetimeMeas + seconds(99));
            
            this.testObj.timeF = 166;
            d = this.testObj.datetimes;
            this.verifyEqual(d(1),   this.datetimeMeas + seconds(33));
            this.verifyEqual(d(end), this.datetimeMeas + seconds(66));
            
            this.verifyEqual(this.testObj.time0, 133);
            this.verifyEqual(this.testObj.timeF, 166);
            
            this.verifyEqual(this.testObj.index0, 34);
            this.verifyEqual(this.testObj.indexF, 67);
        end      
        ...
        function test_time0(this)
            ...
            this.assertWarning(@time0TooEarly, 'mldata:ValueWarning');
            this.assertError(  @time0TooLate, 'mldata:ValueError');            
            % set boundaries            
        ...
        function test_timeF(this)
            ...
            % set out of boundaries
            this.assertError(  @timeFTooEarly, 'mldata:ValueError');
            this.assertWarning(@timeFTooLate, 'mldata:ValueWarning');    
            this.verifyEqual(this.testObj.timeF, 199);
            % set boundaries
		...
		function test_timeWindow(this)
            ...
            this.verifyEqual(this.testObj.datetimeWindow, seconds(0));
            % set sup
            this.verifyWarning(@timeWindowTooLong, 'mldata:ValueWarning');
            this.verifyEqual(this.testObj.indexF, 100);
            this.verifyEqual(this.testObj.timeF, 199);
            this.verifyEqual(this.testObj.datetimeF, this.datetimeMeas + seconds(99));
            this.verifyEqual(this.testObj.timeWindow, 99);
